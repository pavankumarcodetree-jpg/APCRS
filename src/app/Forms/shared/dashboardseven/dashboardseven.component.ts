...
@Component({
  selector: 'app-dashboardseven',
  templateUrl: './dashboardseven.component.html',
  styleUrl: './dashboardseven.component.css'
})
export class DashboardsevenComponent {
  ...
  async get_Age_Group_Data(): Promise<void> {
    try {
      ...
      if (responce.code) {
        ...
        // console.log(this.Dash_Age_Group_List);
