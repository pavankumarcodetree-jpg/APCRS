...
@Component({
  selector: 'app-nac-search-stillbirth-event',
  templateUrl: './nac-search-stillbirth-event.component.html',
  styleUrl: './nac-search-stillbirth-event.component.css'
})
export class NacSearchStillbirthEventComponent {
bsConfig: Partial<BsDatepickerConfig>;
  ...
  async Backwindow() {
    this.viewmodel = 'nacsearchstillbirth';
    this.radiobutton=false;
   }
   radiobutton:boolean=false;NAC_application_Id:any;
   getbuttonenabled(agency:any){
    debugger
    this.applicationnumber=agency.SR_APPLICATION_ID;
    this.NAC_application_Id=agency.SR_NAC_APPLICATION_ID;
    this.radiobutton=true;
    if(agency.SR_APPLICATION_ID!=null){
      this.drafttype = 'STILLBIRTHEDIT';
    }
  }
   getRdo(){
    this.preview_tittle = "Rdo Still Birth Registration(నిర్జీవ శిశువు జనన నమోదు)";
    this.viewmodel="Rdo";
    this.typeofcorrection="Rdo";
    
  }
  PathReportString:any;typeofcorrection:any;applicationid: any;preview_tittle = "";
  viewmodel="nacsearchstillbirth";drafttype='';
