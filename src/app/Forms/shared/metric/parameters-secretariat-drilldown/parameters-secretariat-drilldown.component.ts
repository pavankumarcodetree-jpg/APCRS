...
@Component({
  selector: 'app-parameters-secretariat-drilldown',
  templateUrl: './parameters-secretariat-drilldown.component.html',
  styleUrl: './parameters-secretariat-drilldown.component.css'
})
export class ParametersSecretariatDrilldownComponent {
