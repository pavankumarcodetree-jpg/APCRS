...
@Component({
  selector: 'app-death-cancellation',
  templateUrl: './death-cancellation.component.html',
  styleUrl: './death-cancellation.component.css'
})
export class DeathCancellationComponent {
