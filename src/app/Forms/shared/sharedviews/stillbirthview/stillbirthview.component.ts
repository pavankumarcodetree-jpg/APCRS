...
@Component({
  selector: 'app-stillbirthview',
  templateUrl: './stillbirthview.component.html',
  styleUrl: './stillbirthview.component.css'
})
export class StillbirthviewComponent  {
  ...
  gendermodelchange(obj:any,type:any){
    if(type=='gender'){
      if(obj.checked){
