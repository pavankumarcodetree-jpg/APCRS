...
@Component({
  selector: 'app-birthseekclarification',
  templateUrl: './birthseekclarification.component.html',
  styleUrl: './birthseekclarification.component.css'
})
export class BirthseekclarificationComponent {
  ...
  multitypechangesforcorrection() {
    ...
    if (this.typeofcorrection == 'Clarification') {
      if (this.draft_details_array.childinformation.selgendercheck == '1') {
        this.new_draft_details_array.childinformation.selgendercheck=this.draft_details_array.childinformation.selgendercheck;
        this.gendershow = true;
      }
      if (this.draft_details_array.childinformation.fullnamecheck == '1') {
        this.new_draft_details_array.childinformation.fullnamecheck=this.draft_details_array.childinformation.fullnamecheck;
        this.childnameshow = true;
      }
      if (this.draft_details_array.childinformation.aadhaarcheck == '1') {
        this.new_draft_details_array.childinformation.aadhaarcheck=this.draft_details_array.childinformation.aadhaarcheck;
        this.childaadharshow = true;
      }
      if (this.draft_details_array.fatherInformation.father_full_namercheck == '1') {
        this.new_draft_details_array.fatherInformation.father_full_namercheck=this.draft_details_array.fatherInformation.father_full_namercheck;
        this.fatherfullname = true;
      }
      if (this.draft_details_array.fatherInformation.father_aadhhar_numbercheck == '1') {
        this.new_draft_details_array.fatherInformation.father_aadhhar_numbercheck=this.draft_details_array.fatherInformation.father_aadhhar_numbercheck;
        this.fatheraadharnumber = true;
      }
      if (this.draft_details_array.motherInformation.mother_full_namercheck == '1') {
        this.new_draft_details_array.motherInformation.mother_full_namercheck=this.draft_details_array.motherInformation.mother_full_namercheck;
        this.motherfullname = true;
      }
      if (this.draft_details_array.motherInformation.mother_aadhhar_numbercheck == '1') {
        this.new_draft_details_array.motherInformation.mother_aadhhar_numbercheck=this.draft_details_array.motherInformation.mother_aadhhar_numbercheck;
        this.motheraadhar = true;
      }
      if (this.draft_details_array.addressof_parents.addressof_parentscheck == '1') {
        this.new_draft_details_array.addressof_parents.addressof_parentscheck=this.draft_details_array.addressof_parents.addressof_parentscheck;
        this.Addressofparents = true;
      }
      if (this.draft_details_array.Permanent_addressof_parents.address_permenentcheck == '1') {
        this.new_draft_details_array.Permanent_addressof_parents.address_permenentcheck=this.draft_details_array.Permanent_addressof_parents.address_permenentcheck;
        this.Permanentaddress = true;
      }
      if (this.draft_details_array.legal.number_of_childrencheck == '1') {
        this.new_draft_details_array.legal.number_of_childrencheck=this.draft_details_array.legal.number_of_childrencheck;
        this.numberofchildren = true;
      }
      if (this.draft_details_array.legal.type_of_attention_valcheck == '1') {
        this.new_draft_details_array.legal.type_of_attention_valcheck=this.draft_details_array.legal.type_of_attention_valcheck;
        this.typeofattention = true;
      }
      if (this.draft_details_array.legal.Methodofdeliverycheck == '1') {
        this.new_draft_details_array.legal.Methodofdeliverycheck=this.draft_details_array.legal.Methodofdeliverycheck;
        this.Methodofdelivery = true;
      }
      if (this.draft_details_array.legal.Birthweightcheck == '1') {
        this.new_draft_details_array.legal.Birthweightcheck=this.draft_details_array.legal.Birthweightcheck;
        this.Birthweight = true;
      }
      if (this.draft_details_array.legal.DurationofPregnancycheck == '1') {
        this.new_draft_details_array.legal.DurationofPregnancycheck=this.draft_details_array.legal.DurationofPregnancycheck;
        this.DurationofPregnancy = true;
      }
    }
  }
  ...
  getallcorrectionempty() {
    ...
    this.new_draft_details_array.Permanent_addressof_parents = {
      ...
      new_address_parent_sameasaddress: '',
      new_address_parent_addressof: 'inside',
      new_address_parent_permenent_country: '',
      new_address_parent_permenent_country_val: '',
      new_address_parent_permenent_country_address: '',
      new_address_parent_permenent_country_address_t: '',
  ...
  async Application_final_submit(): Promise<void> {
    try {
       if (this.val.isEmpty(this.userremarks)) {
        ...
        if (!this.staticalvalidationforinputs()) {
        const req = new basemodel();
        req.type = '1009';
        req.param1 = this.applicationid;
  ...
  staticalvalidationforinputs(): boolean{
    let flag = false;
    if(this.numberofchildren){
      ...
      if (this.Number_of_children.invalid) {
        this.alt.toasterror('Please Enter Number of children born alive to the mother');
        flag = true
      }
    }
    if(this.typeofattention){
      ...
      if (this.Type_of_attention.invalid) {
        this.alt.toasterror('Please Select Type of attention');
        flag = true;
      }
    }
    if(this.Methodofdelivery){
      this.Method_of_delivery.control.markAsTouched();
      this.Method_of_delivery.control.updateValueAndValidity();
      if (this.Method_of_delivery.invalid) {
        this.alt.toasterror('Please Select Method of delivery');
        flag = true;
      }
    }
    if(this.Birthweight){
      if(this.Birth_weight){
        ...
        if (this.Birth_weight.invalid) {
          this.alt.toasterror('Please Enter Birth weight');
          flag = true;
        }
      }
    }
    if (this.DurationofPregnancy) {
      ...
      if (this.Duration_of_pregency.invalid) {
        this.alt.toasterror('Please Enter Duration of pregnancy(in weeks)');
        flag = true;
      }
    }
    return flag;
  ...
  DurationofPregnancycheck() {
    if (parseInt(this.new_draft_details_array.legal.new_duration_of_pregency) > 44) {
      this.new_draft_details_array.legal.new_duration_of_pregency = '';
      this.alt.toasterror('Duration of Pregnancy should be less than 44 weeks');
    } else if (
      parseInt(this.new_draft_details_array.legal.new_duration_of_pregency) == 0
    ) {
      this.new_draft_details_array.legal.new_duration_of_pregency = '';
      this.alt.toasterror('Duration of Pregnancy should be less than 44 weeks');
    }
