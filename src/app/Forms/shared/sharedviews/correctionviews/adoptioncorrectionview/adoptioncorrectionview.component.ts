...
@Component({
  selector: 'app-adoptioncorrectionview',
  templateUrl: './adoptioncorrectionview.component.html',
  styleUrl: './adoptioncorrectionview.component.css'
})
export class AdoptioncorrectionviewComponent {
    ...
    if (this.photoselectedFiles.length == 0) {
      ...
      if (this.photoselectedFiles.length != 0) {
        ...
        if (this.photoselectedFiles.length > 0) {
          let maxlen = 0;
          let uploadcheck = 0;
          let typeofbirth = 'Adoption';
          if (this.typeofcorrection == 'Correction') {
            typeofbirth = 'AdoptionCorrection';
          }
          if (this.typeofcorrection == 'Addname') {
            typeofbirth = 'AdoptionAddname';
          }
          if (this.typeofcorrection == 'Cancellation') {
            typeofbirth = 'AdoptionCancellation';
          }
  ...
  @ViewChild('Address_parent_house_no') Address_parent_house_no!: NgModel;
  @ViewChild('Address_parent_building_name') Address_parent_building_name!: NgModel;
  @ViewChild('Address_parent_street_name') Address_parent_street_name!: NgModel;
  @ViewChild('ngaddress_parent_Locality_Post') ngaddress_parent_Locality_Post!: NgModel;
  @ViewChild('Address_parent_pincode') Address_parent_pincode!: NgModel;
  @ViewChild('ngaddress_parent_country') ngaddress_parent_country!: NgModel;
  @ViewChild('mother_surname_name_t') mother_surname_name_t!: NgModel;
  ...
  @ViewChild('Address_parent_permenent_Building_no') Address_parent_permenent_Building_no!: NgModel;
  @ViewChild('Address_parent_permenent_street_name') Address_parent_permenent_street_name!: NgModel;
  @ViewChild('Address_parent_permenent_post_office') Address_parent_permenent_post_office!: NgModel;
  @ViewChild('Address_parent_permenent_pincode') Address_parent_permenent_pincode!: NgModel;
  @ViewChild('Address_permenent_postoff') Address_permenent_postoff!: NgModel;
    ...
    switch (this.typeofcorrection) {
      case 'Correction':
        ...
        if (this.childnameshow) {
          ...
          if (this.ngConfirm_fullname) {
            this.ngConfirm_fullname.control.markAsTouched();
            this.ngConfirm_fullname.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.ngConfirm_fullname.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter confirm Child First Name"; 
              break;
            } 
          }

          if (this.Confirm_surname) {
            this.Confirm_surname.control.markAsTouched();
            this.Confirm_surname.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Confirm_surname.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter confirm Child Last Name"; 
              break;
            } 
          } 
        } 
        if(this.childaadharshow){
          if (this.sel_aadhar) {
            ...
            if (this.sel_aadhar.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Aadhaar Number/EID Number"; 
              break;
            } 
          }
          if(this.new_draft_details_array.childinformation.new_selaadhar == 'Aadhaar'){
          if (this.aadhaar) {
            ...
            if (this.aadhaar.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter  Aadhaar Number"; 
              break;
            } 
          }
        }else{
          if (this.aadhaar) {
            ...
            if (this.aadhaar.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Enrolment Identification(EID) Number"; 
              break;
            } 
          }
        }
        ...
        if(this.fatherfullname){
          if (this.Father__full_namer) {
            ...
            if (this.Father__full_namer.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Father First Name"; 
              break;
            } 
          } 
        ...
        if(this.fathermail){ 
          if (this.Father_email_number) {
            ...
            if (this.Father_email_number.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Father Email Address"; 
              break;
            } 
          } 
        }
        ...
        if(this.fatheraadharnumber){ 
          if (this.Father_aadhhar_number) {
            ...
            if (this.Father_aadhhar_number.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Father Aadhaar Number"; 
              break;
            } 
          } 
        }
        ...
        if(this.motheremail){ 
          if (this.Mother_email) {
            ...
            if (this.Mother_email.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Mother Email Address"; 
              break;
            } 
          }  
        }
        ...
        if(this.motheraadhar){ 
          if (this.Mother_aadhaar_no) {
            ...
            if (this.Mother_aadhaar_no.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Mother Aadhaar Number"; 
              break;
            } 
          }  
        }
        if(this.Addressofparents){ 
          if(this.new_draft_details_array.addressof_parents.new_addressof == 'inside'){
          if (this.Address_parent_state) {
            ...
            if (this.Address_parent_state.invalid) {
              isInvalid = true;
              tostervalue = "Please Select State"; 
              break;
            } 
          } 
          if (this.Address_parent_district) {
            ...
            if (this.Address_parent_district.invalid) {
              isInvalid = true;
              tostervalue = "Please Select District"; 
              break;
            } 
          } 
          if (this.address_parent_rural_urabn) {
            ...
            if (this.address_parent_rural_urabn.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Urban/Rural"; 
              break;
            } 
          }  
          if (this.address_parent_mmc) {
            ...
            if (this.address_parent_mmc.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Mandal/Muncipality"; 
              break;
            } 
          } 
          if (this.Address_parent_Village_Town) {
            ...
            if (this.Address_parent_Village_Town.invalid) {
              isInvalid = true;
              tostervalue = "Please Select village/ward"; 
              break;
            } 
          } 
          if (this.Address_parent_house_no) {
            this.Address_parent_house_no.control.markAsTouched();
            this.Address_parent_house_no.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_house_no.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter House Number"; 
              break;
            } 
          } 
          if (this.Address_parent_building_name) {
            this.Address_parent_building_name.control.markAsTouched();
            this.Address_parent_building_name.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_building_name.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Building No. & Name"; 
              break;
            } 
          } 
          if (this.Address_parent_street_name) {
            this.Address_parent_street_name.control.markAsTouched();
            this.Address_parent_street_name.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_street_name.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Street Name"; 
              break;
            } 
          } 
          if (this.ngaddress_parent_Locality_Post) {
            this.ngaddress_parent_Locality_Post.control.markAsTouched();
            this.ngaddress_parent_Locality_Post.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.ngaddress_parent_Locality_Post.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Locality"; 
              break;
            } 
          } 
          if (this.Address_parent_pincode) {
            this.Address_parent_pincode.control.markAsTouched();
            this.Address_parent_pincode.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_pincode.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter PIN Code"; 
              break;
            } 
          } 
         }else{  
          if (this.ngaddress_parent_country) {
            ...
            if (this.ngaddress_parent_country.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Country"; 
              break;
            } 
          } 
          if (this.mother_surname_name_t) {
            this.mother_surname_name_t.control.markAsTouched();
            this.mother_surname_name_t.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.mother_surname_name_t.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Address Outside India"; 
              break;
            } 
          } 
         }
        ...
        if(this.Permanentaddress){   
          ...
          if(this.new_draft_details_array.Permanent_addressof_parents.new_address_parent_addressof === ""){
            isInvalid = true;
            tostervalue = "please select In India/Outside India"; 
            break;
          }

          if(this.new_draft_details_array.Permanent_addressof_parents.new_address_parent_addressof == 'inside'){
          ...
          if (this.Address_parent_permenent_Building_no) {
            this.Address_parent_permenent_Building_no.control.markAsTouched();
            this.Address_parent_permenent_Building_no.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_permenent_Building_no.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Building No. & Name"; 
              break;
            } 
          } 
          if (this.Address_parent_permenent_street_name) {
            this.Address_parent_permenent_street_name.control.markAsTouched();
            this.Address_parent_permenent_street_name.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_permenent_street_name.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Street Name"; 
              break;
            } 
          } 
          if (this.Address_parent_permenent_post_office) {
            this.Address_parent_permenent_post_office.control.markAsTouched();
            this.Address_parent_permenent_post_office.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_permenent_post_office.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter Locality"; 
              break;
            } 
          } 
          if (this.Address_parent_permenent_pincode) {
            this.Address_parent_permenent_pincode.control.markAsTouched();
            this.Address_parent_permenent_pincode.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_parent_permenent_pincode.invalid) {
              isInvalid = true;
              tostervalue = "Please Enter PIN Code"; 
              break;
            } 
          } 
          if (this.Address_permenent_postoff) {
            this.Address_permenent_postoff.control.markAsTouched();
            this.Address_permenent_postoff.control.updateValueAndValidity();
            // this.foc_sel_gender.nativeElement.focus();
            if (this.Address_permenent_postoff.invalid) {
              isInvalid = true;
              tostervalue = "Please Select post office"; 
              break;
            } 
          } 
         }else{  
        ...
        if(this.PlaceofBirth){  
          if (this.Place_of_birth) {
            ...
            if (this.Place_of_birth.invalid) {
              isInvalid = true;
              tostervalue = "Please Select Place of Birth"; 
              break;
            } 
          } 
          if(this.new_draft_details_array.placeofbirth.new_place_of_birth=='1'){
            if (this.ngHospitalName) {
              ...
              if (this.ngHospitalName.invalid) {
                isInvalid = true;
                tostervalue = "Please Select Hospital Name"; 
                break;
              } 
            } 
          } else{
            if (this.Place_of_birth_state) {
          ...
          if (this.Place_of_birth_district) {
          ...
          if (this.Place_of_birth_sub_district) {
      ...
      case 'Addname':
        ...
        if (this.Surname) {
          ...
          if (this.ngConfirm_fullname.invalid) 
            {
              isInvalid = true;
              tostervalue="Please Enter Child Confirm Name";
            }
        }if (this.Confirm_surname) {
          this.Confirm_surname.control.markAsTouched();
          this.Confirm_surname.control.updateValueAndValidity();
        ...
        if (
          ...
          this.new_draft_details_array.childinformation.new_confirm_surname.toUpperCase() && !this.val.isEmpty(this.new_draft_details_array.childinformation.new_confirm_surname)
        ) {
          this.Surname.control.markAsTouched();
          this.Surname.control.updateValueAndValidity();
          this.Confirm_surname.control.markAsTouched();
        ...
        if (!this.val.isEmpty(this.new_draft_details_array.childinformation.new_middlename) &&
          ...
          this.new_draft_details_array.childinformation.new_confirm_middle.toUpperCase() && !this.val.isEmpty(this.new_draft_details_array.childinformation.new_confirm_middle)
        ) {
          this.Surname.control.markAsTouched();
          this.Surname.control.updateValueAndValidity();
          this.Confirm_surname.control.markAsTouched();
