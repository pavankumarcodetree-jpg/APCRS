...
@Component({
  selector: 'app-oldbirthcorrectionview',
  templateUrl: './oldbirthcorrectionview.component.html',
  styleUrl: './oldbirthcorrectionview.component.css'
})
export class OldbirthcorrectionviewComponent {
@Input() applicationid: any;
  @Input() selecttab: any;
  @Input() typeofcorrection: any;
  @Input() applicationregid: any;
  @Input() oldbirthview: any;
  ...
  RU_CODE: any;
  async ngOnInit() { 
     console.log(this.table_card_sub_select)
