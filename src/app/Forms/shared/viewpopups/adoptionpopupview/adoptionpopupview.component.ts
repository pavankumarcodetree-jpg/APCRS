...
@Component({
    selector: 'app-adoptionpopupview',
    templateUrl: './adoptionpopupview.component.html',
    styleUrl: './adoptionpopupview.component.css'
})
export class AdoptionpopupviewComponent {
    ...
    draft_details_array = {
        ...
        adoptionmotherInformation: {
            ...
            adoption_mother_middle_name: '',
            adoption_mother_middle_name_t: '',
