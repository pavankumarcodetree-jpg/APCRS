...
@Component({
    selector: 'app-stillbirthpopupview',
    templateUrl: './stillbirthpopupview.component.html',
    styleUrl: './stillbirthpopupview.component.css'
})
export class StillbirthpopupviewComponent {
