...
@Component({
    selector: 'app-adoptionregistration',
    templateUrl: './adoptionregistration.component.html',
    styleUrl: './adoptionregistration.component.css'
})
export class AdoptionregistrationComponent {
    contentuploadurl = '';
    contentshowurl = '';
    ...
    adoptioninfohide: boolean = false;
    ...
    draft_details_array = {
        ...
        adoptionfatherInformation: {
            adoption_father_full_namer: '',
            adoption_father_full_namer_t: '',
            adoption_father_full_namer_val: '',
            adoption_father_surname: '',
            adoption_father_surname_t: '',
            adoption_father_middlename: '',
            adoption_father_middlename_t: '',
            adoption_father_surname_val: '',
            adoption_father_mobile_number: '',
            adoption_father_email_number: '',
            adoption_father_aadhhar_number_mask: '',
            adoption_father_aadhhar_number: '',
            adoption_fathername_value: '',
        },
        adoptionmotherInformation: {
            adoption_mother_full_namer: '',
            adoption_mother_full_namer_t: '',
            adoption_mother_full_namer_val: '',
            adoption_mother_surname: '',
            adoption_mother_surname_t: '',
            adoption_mother_middlename: '',
            adoption_mother_middlename_t: '',
            adoption_mother_surname_val: '',
            adoption_mother_mobile_number: '',
            adoption_mother_email_number: '',
            adoption_mother_aadhhar_number: '',
            adoption_mother_aadhaar_number_mask: '',
            adoption_mothername_value: '',
        },

        adoption_deed_order_details: {
            adoption_deed_or_order: '',
            adoption_deed_or_order_date: '',
            adoption_deed_or_order_number: '',
        },
        addressof_parents: {
            addressof: 'inside',
    ...
    registerediddisabled : boolean = false;
    async getbirth_details(): Promise<void> {
        try {
            debugger
            let rsdata: any
            ...
            this.spinner.show();
            req.type = '1015';
            req.param1 = this.draft_details_array.childinformation.childregistered_id;
            req.param2 = 'BIRTH';
            rsdata = await this.auth.auth_pkgcrsbirth_service(req);
            this.spinner.hide();
            if (rsdata.code) {
                if (rsdata.code && rsdata.Details[0].STATUS == '1') {  
                    let arraydetailsdata = this.replaceNullWithEmptyString(JSON.parse(rsdata.Details[0].JSON_RESULT));
                    arraydetailsdata.adoption_deed_order_details = {
                        adoption_deed_or_order: '',
                        adoption_deed_or_order_date: '',
                        adoption_deed_or_order_number: '',
                    };
                    arraydetailsdata.adoptionfatherInformation = {
                        adoption_father_full_namer: '',
                        adoption_father_full_namer_t: '',
                        adoption_father_full_namer_val: '',
                        adoption_father_surname: '',
                    ...
                    arraydetailsdata.adoptionmotherInformation = {
                        adoption_mother_full_namer: '',
                        adoption_mother_full_namer_t: '',
                        adoption_mother_full_namer_val: '',
                        adoption_mother_surname: '',
                    ...
                    arraydetailsdata.addressof_parents = {
                        addressof: 'inside',
                        address_parent_country: '',
                        address_parent_country_val: '',
                        address_parent_country_address: '',
                    ...
                    arraydetailsdata.childinformation.childregistered_id = this.draft_details_array.childinformation.childregistered_id;
                    arraydetailsdata.childinformation.childregistered = 'Yes';
                    this.birthreg_backwindowdraftbinding(arraydetailsdata);
                    this.registerediddisabled = true;
                    this.adoptioninfohide = true;
                }
    ...
    getvaluesempty() {
        this.draft_details_array.childinformation.confirm_fullname_val = '';
        this.draft_details_array.childinformation.confirm_surname_val = '';
        this.draft_details_array.childinformation.surname_val = '';
        this.draft_details_array.childinformation.fullname_val = '';
        this.draft_details_array.childinformation.selgender_val = '';


        this.draft_details_array.fatherInformation.father_full_namer_val = '';
        this.draft_details_array.fatherInformation.father_surname_val = '';
        this.draft_details_array.fatherInformation.fathername_value = '';


        this.draft_details_array.motherInformation.mother_full_namer_val = '';
        this.draft_details_array.motherInformation.mothername_value = '';
        this.draft_details_array.motherInformation.mother_surname_val = '';

        this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer_val = '';
        this.draft_details_array.adoptionfatherInformation.adoption_father_surname_val = '';
        this.draft_details_array.adoptionfatherInformation.adoption_fathername_value = '';

        this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer_val = '';
        this.draft_details_array.adoptionmotherInformation.adoption_mother_surname_val = '';
        this.draft_details_array.adoptionmotherInformation.adoption_mothername_value = '';

        this.draft_details_array.addressof_parents.address_parent_country_val = '';
        this.draft_details_array.addressof_parents.address_parent_country_address_val = '';
        this.draft_details_array.addressof_parents.address_parent_state_val = '';
        this.draft_details_array.addressof_parents.address_parent_district_val = '';
        this.draft_details_array.addressof_parents.address_parent_rural_urabn_val = '';
        this.draft_details_array.addressof_parents.address_parent_mmc_val = '';
        this.draft_details_array.addressof_parents.address_parent_Village_Town_val = '';
        this.draft_details_array.addressof_parents.address_parent_building_name_val = '';
        this.draft_details_array.addressof_parents.address_parent_house_no_val = '';
        this.draft_details_array.addressof_parents.address_parent_street_name_val = '';
        this.draft_details_array.addressof_parents.address_parent_postoff_val = '';


        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_country_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_country_address_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_state_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_district_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_mmc_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_rural_urabn_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_village_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_building_no_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_hose_no_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_street_name_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_parent_permenent_locality_post_office_val = '';
        this.draft_details_array.Permanent_addressof_parents.address_permenent_postoff_val = '';


        this.draft_details_array.placeofbirth.place_of_birth_hospital_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_state_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_district_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_mmc_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_rural_urabn_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_village_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_building_no_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_house_no_val = '';
        this.draft_details_array.placeofbirth.place_of_birth_street_name_val = '';
        this.draft_details_array.placeofbirth.Place_of_birth_locality_val = '';
        this.draft_details_array.placeofbirth.Place_of_birth_postoff_val = '';
        this.draft_details_array.placeofbirth.placeofbirth_value = '';


        this.draft_details_array.information.Informant_fullname_val = '';
        this.draft_details_array.information.Informant_address_val = '';
        this.draft_details_array.information.information_value = '';

        this.draft_details_array.legal.mother_residence_state_val = '';
        this.draft_details_array.legal.mother_residence_district_val = '';
        this.draft_details_array.legal.mother_residence_rural_urban_val = '';
        this.draft_details_array.legal.mother_residence_Mmc_val = '';
        this.draft_details_array.legal.mother_residence_Village_val = '';
        this.draft_details_array.legal.father_religion_val = '';
        this.draft_details_array.legal.father_education_val = '';
        this.draft_details_array.legal.father_occupation_val = '';
        this.draft_details_array.legal.mother_religion_val = '';
        this.draft_details_array.legal.mother_eduaction_val = '';
        this.draft_details_array.legal.mother_occupation_val = '';
        this.draft_details_array.legal.type_of_attention_val = '';
        this.draft_details_array.legal.method_of_delivery_val = '';
        this.draft_details_array.legal.mother_residence_value = '';
    }

    RU_CODE: any; UROLE: any; obj: any; declarationcheck = false; seconddeclarationcheck = false;
    ngOnInit(): void {
        try {
    ...
    adoptinforamtiondetails() {
        this.adoptioninfohide = false;
    ...
    async PlaceofBirthchange() {
        ...
        if (this.UROLE == '105' || this.UROLE == '112' || this.UROLE == '111') {
    ...
    birthalreadyform_alert() {
        Swal.fire({
            //title: 'Please Confirm !దయచేసి నిర్ధారించండి !',
            text: 'please apply modifications to the registered birth in the concerned registrar login ? / దయచేసి సంబంధిత రిజిస్ట్రార్ లాగిన్‌లో నమోదైన జననానికి సవరణలను వర్తింపజేయండి?',
            confirmButtonText: 'Continue',
        }).then((result) => {

        });
    }
    Childregisteredclear(event: any) {
        const isChecked = event.target.checked;
        if (isChecked) {   
            this.birthalreadyform_alert();
            this.draft_details_array.childinformation.childregistered = isChecked;
            
        } else { 
            this.registerediddisabled = false;
            this.adoptioninfohide = false;
        ...
        try {
            ...
            if (rsdata.code) {
                if (rsdata.code && rsdata.Details[0].STATUS == '1') {
                    ...
                    this.seconddeclarationcheck = false;
                    this.ModalCLose();
                ...
                if (rsdata.code && rsdata.Details[0].STATUS == '0') {
                    this.declarationcheck = false; this.seconddeclarationcheck = false;
                    this.alt.toasterror(rsdata.Details[0].STATUS_TEXT + rsdata.Details[0].STATUS_TEXT_TEL);
                }
                this.spinner.hide();
            } else {
            ...
            if (this.photoselectedFiles.length != 0) {
                ...
                if (this.photoselectedFiles.length > 0) {
                    ...
                    for (let ph = 0; ph < maxlen; ph++) {
                        ...
                        phform.append('input01', 'Adoption');
                        phform.append('input02', 'adoptionregistration');
        ...
        this.pscall.google_translate(inputkeyval).subscribe(
            (response: any) => {
                ...
                if (response[0] != '') // if (response[0] == 'SUCCESS')
                {
                    ...
                    if (inputsource == 'adoption_father_full_namer') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_father_full_namer_tel') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_father_surname') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_surname_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_father_surname_tel') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_surname_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_father_middlename') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_middlename_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_father_middlename_t') {
                        this.draft_details_array.adoptionfatherInformation.adoption_father_middlename_t = this.suggestions[0];
                    }
                    ...
                    if (inputsource == 'adoption_mother_full_name') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_mother_full_name_tel') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_mother_surname_name') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_surname_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_mother_surname_name_tel') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_surname_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_mother_middle_name') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_middlename_t = this.suggestions[0];
                    }
                    if (inputsource == 'adoption_mother_middle_name_t') {
                        this.draft_details_array.adoptionmotherInformation.adoption_mother_middlename_t = this.suggestions[0];
                    }
    ...
    onDateChange(event: any, type: any) {
        ...
        if (type == 'DateofAdoption') {

            this.draft_details_array.adoption_deed_order_details.adoption_deed_or_order_date =
                formattedDate || '';
        }
    }
    ...
    async validateaadhaar(aadhaar: any, inputsource: any) {
        ...
        if (aadhaar.length === 12 && checknumaric == true) {
            ...
            if (isValidAadhaar == false) {
                ...
                if (inputsource == 'adoptionfatheraadhaar') {
                    this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number = '';
                    this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask =
                        '';
                }
                if (inputsource == 'adoptionmotheraadhaar') {
                    this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number = '';
                    this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask =
                        '';
                }
            ...
            if (isValidAadhaar == true) {
                ...
                if (inputsource == 'adoptionfatheraadhaar') {
                    this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number = this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask;
                    this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask =
                        this.maskinput(
                            this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask
                        );
                ...
                if (inputsource == 'adoptionmotheraadhaar') {
                    this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number = this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask;
                    this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask =
                        this.maskinput(
                            this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask
                        );
    ...
    validateaadharchildparent(inputsource: any) {
        ...
        if (inputsource == 'childaadhaar') {
            ...
            if (this.draft_details_array.childinformation.aadhaar == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
                this.draft_details_array.childinformation.aadhaarmask = '';
                this.alt.toasterror('Child Aadhaar Number and Adoption Father Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.childinformation.aadhaar == this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
                this.draft_details_array.childinformation.aadhaarmask = '';
                this.alt.toasterror('Child Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
        }
        if (inputsource == 'fatheraadhaar') {
            ...
            if (this.draft_details_array.fatherInformation.father_aadhhar_number == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
                this.draft_details_array.fatherInformation.father_aadhhar_number_mask = '';
                this.alt.toasterror('Father Aadhaar Number and Adoption Father Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.fatherInformation.father_aadhhar_number == this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
                this.draft_details_array.fatherInformation.father_aadhhar_number_mask = '';
                this.alt.toasterror('Father Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
        }
        if (inputsource == 'motheraadhaar') {
            ...
            if (this.draft_details_array.information.Informant_aadhhar_no == this.draft_details_array.motherInformation.mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.information.Informant_aadhhar_no_mask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Mother Aadhaar Number and Information Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.motherInformation.mother_aadhhar_number == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Mother Aadhaar Number and Adoption Father Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.motherInformation.mother_aadhhar_number == this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Mother Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
        }
        if (inputsource == 'adoptionfatheraadhaar') {
            if (this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number == this.draft_details_array.childinformation.aadhaar && !this.val.isEmpty(this.draft_details_array.childinformation.aadhaarmask)) {
                this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask = '';
                this.alt.toasterror('Adoption Father Aadhaar Number and Child Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.motherInformation.mother_aadhhar_number == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.motherInformation.mother_aadhaar_number_mask)) {
                this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask = '';
                this.alt.toasterror('Adoption Father Aadhaar Number and Mother Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
                this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask = '';
                this.alt.toasterror('Adoption father Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.information.Informant_aadhhar_no == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.information.Informant_aadhhar_no_mask)) {
                this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask = '';
                this.alt.toasterror('Adoption Father Aadhaar Number and Information Aadhaar Number should not be same');
                return;
            }
        }
        if (inputsource == 'adoptionmotheraadhaar') {
            if (this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number == this.draft_details_array.childinformation.aadhaar && !this.val.isEmpty(this.draft_details_array.childinformation.aadhaarmask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Adoption Mother Aadhaar Number and Child Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number == this.draft_details_array.fatherInformation.father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.fatherInformation.father_aadhhar_number_mask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Adoption Mother Aadhaar Number and Father Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
                this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask = '';
                this.alt.toasterror('Adoption father Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.information.Informant_aadhhar_no == this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.information.Informant_aadhhar_no_mask)) {
                this.draft_details_array.motherInformation.mother_aadhaar_number_mask = '';
                this.alt.toasterror('Adoption Mother Aadhaar Number and Information Aadhaar Number should not be same');
                return;
            }
        }
        if (inputsource == 'informationaadhaar') {
            ...
            if (this.draft_details_array.information.Informant_aadhhar_no == this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
                this.draft_details_array.information.Informant_aadhhar_no_mask = '';
                this.alt.toasterror('Information Aadhaar Number and Adoption Father Aadhaar Number should not be same');
                return;
            }
            if (this.draft_details_array.information.Informant_aadhhar_no == this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhhar_number && !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
                this.draft_details_array.information.Informant_aadhhar_no_mask = '';
                this.alt.toasterror('Information Aadhaar Number and Adoption Mother Aadhaar Number should not be same');
                return;
            }
        }
    ...
    enableLegalTab() {
        this.Adoptive_father_Aadharno_status = false;
        this.Adoptive_mother_Aadharno_status = false;
    ...
    @ViewChild('ngAdoption_deed_or_order') ngAdoption_deed_or_order!: NgModel;
    @ViewChild('Adoption_deed_or_order_date') Adoption_deed_or_order_date!: NgModel;
    @ViewChild('Adoption_deed_or_order_number') Adoption_deed_or_order_number!: NgModel;
    ...
    legal_from_check_inpts() {
        ...
        if (this.ngAdoption_deed_or_order) {
            this.ngAdoption_deed_or_order.control.markAsTouched();
            this.ngAdoption_deed_or_order.control.updateValueAndValidity();
            if (this.ngAdoption_deed_or_order.invalid) isInvalid = true;
        }
        if (this.Adoption_deed_or_order_date) {
            this.Adoption_deed_or_order_date.control.markAsTouched();
            this.Adoption_deed_or_order_date.control.updateValueAndValidity();
            if (this.Adoption_deed_or_order_date.invalid) isInvalid = true;
        }
        if (this.Adoption_deed_or_order_number) {
            this.Adoption_deed_or_order_number.control.markAsTouched();
            this.Adoption_deed_or_order_number.control.updateValueAndValidity();
            if (this.Adoption_deed_or_order_number.invalid) isInvalid = true;
        }
    ...
    Adoptive_father_Aadharno_status = false;
    Adoptive_mother_Aadharno_status = false;
    ...
    adoption_father_mother_check_status = false;
    adoption_father_check_status = false;
    adoption_mother_check_status = false;
    legal_checkAndShowAlert() {
        debugger
        if (this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask) && !this.Adoptive_father_Aadharno_status) {
            this.swalform_alert("Do you want to continue without Adoptive Father's Aadhar Number?మీరు తండ్రి ఆధార్ నంబర్ లేకుండా కొనసాగించాలనుకుంటున్నారా?", "adoptivefatheraadharno")
        }
        if (!this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_aadhhar_number_mask)) {
            this.Adoptive_father_Aadharno_status = true;
        } 
        if (this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask) && !this.Adoptive_mother_Aadharno_status) {
            this.swalform_alert("Do you want to continue without Adoptive Mother's Aadhar Number?మీరు తల్లి ఆధార్ నంబర్ లేకుండా కొనసాగించాలనుకుంటున్నారా?", "adoptivemotheraadharno")
        }
        if (!this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_aadhaar_number_mask)) {
            this.Adoptive_mother_Aadharno_status = true;
        } 
        ...
        if (this.val.isEmpty(this.draft_details_array.childinformation.fullname) && !this.child_name_status) {
            this.swalform_alert("Do you want to continue without Child's Name? బిడ్డ పేరు లేకుండానే కొనసాగించదలచుకున్నారా?", "childname")
        }
        ...
        // Adoption father and mother check
        if (this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer) && !this.adoption_father_check_status) {
            this.swalform_alert("Do you want to keep the information of Adoptive father blank? మీరు పెంపుడు తండ్రి సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?", "adoptionfather");
        }
        if (!this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer)) {
            this.adoption_father_check_status = true;
        }
        if (this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer) && !this.adoption_mother_check_status) {
            this.swalform_alert("Do you want to keep the information of Adoptive mother blank? మీరు పెంపుడు తల్లి సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?", "adoptionmother");
        }
        if (!this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer)) {
            this.adoption_mother_check_status = true;
        }
        if (this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer) && this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer) && !this.adoption_father_mother_check_status) {
            this.swalform_alert("Do you want to keep the information of Adoptive mother and father blank? మీరు పెంపుడు తల్లి మరియు పెంపుడు తండ్రి సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?", "adoptionmother_father");
        }
        if (!this.val.isEmpty(this.draft_details_array.adoptionfatherInformation.adoption_father_full_namer) || !this.val.isEmpty(this.draft_details_array.adoptionmotherInformation.adoption_mother_full_namer)) {
            this.adoption_father_mother_check_status = true;
        }


        if (this.mother_check_status && this.father_check_status && this.father_mother_check_status && this.child_name_status && this.adoption_father_mother_check_status && this.adoption_father_check_status && this.adoption_mother_check_status && this.child_Aadharno_status && this.mother_Aadharno_status && this.father_Aadharno_status  && this.Adoptive_father_Aadharno_status && this.Adoptive_mother_Aadharno_status) {
            ...
            // this.father_check_status = false;
            // this.mother_check_status = false;
            // this.adoption_father_mother_check_status = false;
            // this.adoption_father_check_status = false;
            // this.adoption_mother_check_status = false;
        }
        this.spinner.hide();
    }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (type == "mother") {
                    ...
                    this.child_name_status = true;
                } else if (type == "adoptionmother") {
                    this.adoption_mother_check_status = true;
                } else if (type == "adoptionfather") {
                    this.adoption_father_check_status = true;
                } else if (type == "adoptionmother_father") {
                    this.adoption_father_mother_check_status = true;
                    ...
                    this.mother_Aadharno_status = true;
                }  else if (type == "adoptivefatheraadharno") {
                    this.Adoptive_father_Aadharno_status = true;
                }   else if (type == "adoptivemotheraadharno") {
                    this.Adoptive_mother_Aadharno_status = true;
                }
                this.legal_checkAndShowAlert();
            }
    ...
    //     console.log('draft_details_array', this.draft_details_array);
    //    // this.clearinputsaddress();
    ...
    //     if (this.draft_details_array.childinformation.fullname != '') {
    //         this.draft_details_array.childinformation.childnotnamed = false;
    //     } else {
    //         this.draft_details_array.childinformation.childnotnamed = true;
    //     }
    //     if (this.draft_details_array.childinformation.childregistered_id != '') {
    //         this.draft_details_array.childinformation.childregistered = true;
    //     } else {
    //         this.draft_details_array.childinformation.childregistered = false;
    //     }
    //     this.Addressofparents_district_array = [];
    ...
    async birthreg_backwindowdraftbinding(obj: any) {
        
        let val = (this.draft_details_array.childinformation.childregistered_state);
        this.draft_details_array = obj;
        
        
        this.draft_details_array.childinformation.childregistered_state = val;
        this.draft_details_array.childinformation.childregistered_state = this.obj[0].STATE_CODE;
        console.log(this.draft_details_array.childinformation.childregistered_state);
        if (this.draft_details_array.language.dateofreport == null || this.draft_details_array.language.dateofreport == "" || this.draft_details_array.language.dateofreport == undefined) {
            this.draft_details_array.language.dateofreport = this.datepipe.transform(new Date(), 'dd-MM-yyyy');
        }
        if (this.draft_details_array.addressof_parents.addressof == null || this.draft_details_array.addressof_parents.addressof == "" || this.draft_details_array.addressof_parents.addressof == undefined) {
        ...
        this.draft_details_array.childinformation.confirmdateofbirth = this.draft_details_array.childinformation.dateofbirth;
        // if(this.draft_details_array.childinformation.fullname!=''){
        //   this.draft_details_array.childinformation.childnotnamed='1';
        // }else{
        //   this.draft_details_array.childinformation.childnotnamed='0';
        // }
        this.Addressofparents_district_array = [];
        this.Addressofparents_district_array.push({
            DISTRICT_CODE:
