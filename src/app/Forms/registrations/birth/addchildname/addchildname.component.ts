...
@Component({
  selector: 'app-addchildname',
  templateUrl: './addchildname.component.html',
  styleUrl: './addchildname.component.css'
})
export class AddchildnameComponent {
  contentuploadurl = '';
  contentshowurl = '';
  constructor(
      ...
      if (this.photoselectedFiles.length != 0) {
        ...
        if (this.photoselectedFiles.length > 0) {
          ...
          for (let ph = 0; ph < maxlen; ph++) {
            ...
            phform.append('input01', 'Addchildname');
            phform.append('input02', 'addchildnameregistration');
  ...
  legal_checkAndShowAlert() {
    ...
    if (this.mother_check_status && this.father_check_status && this.father_mother_check_status && this.child_name_status) {
