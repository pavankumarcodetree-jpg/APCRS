...
@Component({
  selector: 'app-death-register-old-data',
  templateUrl: './death-register-old-data.component.html',
  styleUrl: './death-register-old-data.component.css'
})
export class DeathRegisterOldDataComponent {
  contentuploadurl = '';
  contentshowurl = '';
  ...
  async PlaceofDeathchange() {
    ...
    if (this.UROLE == '105' || this.UROLE == '112' || this.UROLE == '111' || this.UROLE == '1007') {
      ...
      } else if (this.obj[0].HOSPITAL_ID != "" && this.UROLE == '105') {
  ...
  async get_Typeofattention(): Promise<void> {
    try {
      ...
      req.param2 = this.Hospital_master_array.find(x => x.HOSPITAL_CODE == this.draft_details_array.PlaceofDeath.PlaceofDeath).HOSPITAL_CATEGORY;
      req.param25 = 'DEATH';
      this.spinner.show();
      ...
      if (this.photoselectedFiles.length != 0) {
        ...
        if (this.photoselectedFiles.length > 0) {
          ...
          for (let ph = 0; ph < maxlen; ph++) {
            ...
            phform.append('input01', 'OLDDEATH');
            phform.append('input02', 'olddeathregistration');
  ...
  async documentinsert(): Promise<void> {
    try {
      ...
      this.spinner.show();
      let rsdata: any = await this.auth.auth_pkgcrsolddeath_service(req);
  ...
  dateofdeathmax = new Date(); dateofdeathmin!: Date; mindateForRegistration!: Date;
  ...
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.motherInformation.mother_full_name) && this.val.isEmpty(this.draft_details_array.fatherInformation.father_full_namer)) {
  //       anyvalid = false;
  ...
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.motherInformation.mother_full_name) && this.val.isEmpty(this.draft_details_array.MaritalStatus.Spouse_FullName)) {
  //       anyvalid = false;
  ...
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.fatherInformation.father_full_namer) && this.val.isEmpty(this.draft_details_array.MaritalStatus.Spouse_FullName)) {
  //       anyvalid = false;
  ...
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.motherInformation.mother_full_name)) {
  //       anyvalid = false;
  //       this.swalform_alert("Do you want to keep the information of mother blank? మీరు తల్లి సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?");
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.MaritalStatus.Spouse_FullName)) {
  //       anyvalid = false;
  //       this.swalform_alert("Do you want to keep the information of spouse blank? మీరు భార్య/భర్త సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?");
  //     }
  //     else if (this.val.isEmpty(this.draft_details_array.fatherInformation.father_full_namer)) {
  //       anyvalid = false;
  //       this.swalform_alert("Do you want to keep the information of father blank? మీరు తండ్రి సమాచారము ఖాళీగా ఉంచదలచుకున్నారా?");
  //     }
  ...
  async legal_checkAndShowAlert() {
    ...
    if (this.father_mother_spouse_check_status) {  // ensure alerts were shown and confirmed
      this.isConfirmLegalEnabled = true;
  ...
  deatholddatachange() {
    if (this.draft_details_array.PlaceofDeath.PlaceofDeath == "1") {
      let HospitalDetails = this.Hospital_master_array.find(e => e.HOSPITAL_ID == this.draft_details_array.PlaceofDeath.HospitalName);
