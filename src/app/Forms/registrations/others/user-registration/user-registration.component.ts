...
export class UserRegistrationComponent {
    ...
    user_reg_form = {
        ...
        pincode: '', dateofposting: '', street_name: '', hsno: '', building_name: '', aadhaarno: '', aadhaarmask: '',RevenueDivision:'',departmentaldistrict:'',departmentalmandal:'',departmentalrural_urban:''
    }
    RU_CODE = '';objdistrict='0';
    ngOnInit(): void {
        if (sessionStorage.getItem('_Uenc') !== '') {
            ...
            if (obj != '' && obj != undefined && obj != null) {
                ...
                this.objdistrict=obj[0].DISTRICT_CODE;
                if(obj[0].DISTRICT_CODE!='0' && obj[0].DISTRICT_CODE!=null && obj[0].DISTRICT_CODE!=undefined){
                    this.user_reg_form.district = obj[0].DISTRICT_CODE;
                    
                }
                if(obj[0].MMC_CODE!='0' && obj[0].MMC_CODE!=null && obj[0].MMC_CODE!=undefined){
    ...
    async get_registrar_district(): Promise<void> {
        ...
        try {
            ...
            if (responce.code) {
                ...
                if(this.user_reg_form.district!='' && this.user_reg_form.district!=null && this.user_reg_form.district!=undefined){
        ...
        // }
            ...
            try {
                ...
                if (responce.code) {
                    ...
                    console.log('mandal',this.user_reg_form.mandal)
                    if(this.user_reg_form.mandal!='' &&  this.user_reg_form.mandal!='0' && this.user_reg_form.mandal!=null && this.user_reg_form.mandal!=undefined){
    ...
    update_modal_open(obj: any) {
        ...
        let originalaadhaar: any = this.update_user_reg_form.update_aadhaarno.toString();
        const maskedAadhaar = originalaadhaar.replace(/\d(?=\d{4})/g, '*');
        this.update_user_reg_form.update_aadhaarmask = maskedAadhaar;
