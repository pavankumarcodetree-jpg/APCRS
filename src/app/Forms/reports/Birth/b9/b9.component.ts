...
@Component({
    selector: 'app-b9',
    templateUrl: './b9.component.html',
    styleUrl: './b9.component.css'
})
export class B9Component {
...
this.get_b9_level();
    ...
    async get_b9_level(): Promise<void> {
        ...
        if (this.to_date === null || this.to_date === undefined) {
            ...
            try {
                ...
                if (responce.code) {
                    this.spinner.hide();
                    this.b9_levle_array = responce.Details;
                    //console.log(this.b9_levle_array);
