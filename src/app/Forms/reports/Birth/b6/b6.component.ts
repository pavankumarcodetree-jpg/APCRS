...
export class B6Component {
    ...
    async get_statelevel(): Promise<void> {
        ...
        req.param4="0";
                ...
                this.state_levle_array_b6 = [];
                this.spinner.show();
                if (responce.code) {
                    this.spinner.hide();
                    this.state_levle_array_b6 = responce.Details;
                    //console.log(this.state_levle_array_b6);
