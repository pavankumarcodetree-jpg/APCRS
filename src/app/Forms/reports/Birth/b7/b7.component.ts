...
export class B7Component {
    ...
    ngOnInit(): void {
        if (sessionStorage.getItem('_Uenc') !== '') {
            ...
            if (this.obj != '' && this.obj != undefined && this.obj != null) {
                ...
                // this.districtcode=this.obj[0].DISTRICT_CODE;
                // this.mandalcode=this.obj[0].MMC_CODE;
                // this.villagecode=this.obj[0].VW_CODE;
                this.get_b7_level();
    ...
    async get_b7_level(): Promise<void> {
        ...
        if (this.to_date === null || this.to_date === undefined) {
            ...
            try {
                ...
                if (responce.code) {
                    this.spinner.hide();
                    this.b7_levle_array = responce.Details;
                    console.log(this.b7_levle_array);
