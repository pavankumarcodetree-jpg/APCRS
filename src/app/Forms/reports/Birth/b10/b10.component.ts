...
@Component({
    selector: 'app-b10',
    templateUrl: './b10.component.html',
    styleUrl: './b10.component.css'
})
export class B10Component {
...
this.get_state_level();
    ...
    async get_state_level(): Promise<void> {
        ...
        if (this.to_date === null || this.to_date === undefined) {
            ...
            try {
                ...
                this.b10_levle_array = [];
                this.spinner.show();
                if (responce.code) {
                    this.spinner.hide();
                    this.b10_levle_array = responce.Details;
                    //console.log(this.b10_levle_array);
